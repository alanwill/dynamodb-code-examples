...
request_parameters =  '{'
request_parameters +=  '"TableName": "TestTable",'
request_parameters +=  '"Item": {'
request_parameters +=          '"Name": {'
request_parameters +=              '"S": "John Demo"'
request_parameters +=          '},'
request_parameters +=          '"Id": {'
request_parameters +=              '"S": "2"'
request_parameters +=          '},'
request_parameters +=          '"Message": {'
request_parameters +=              '"S": "This is a test...and it works"'
request_parameters +=          '},'
request_parameters +=          '"LastBy": {'
request_parameters +=              '"S": "whatever@example.com"'
request_parameters +=          '}'
request_parameters +=      '}'
request_parameters +=  '}'
